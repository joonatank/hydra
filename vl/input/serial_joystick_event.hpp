...
#ifndef HYDRA_INPUT_SERIAL_JOYSTICK_EVENT_HPP
#define HYDRA_INPUT_SERIAL_JOYSTICK_EVENT_HPP
...
struct SerialJoystickEvent
{
	SerialJoystickEvent(void)
		: axis_x(0)
		, axis_y(0)
		, axis_z(0)
		, buttons(0)
	...
	SerialJoystickEvent &
	operator-=(SerialJoystickEvent const &a)
	{
		axis_x -= a.axis_x;
		axis_y -= a.axis_y;
		axis_z -= a.axis_z;
...
inline std::ostream &
operator<<(std::ostream &os, SerialJoystickEvent const &evt)
{
...
operator-(SerialJoystickEvent const &a, SerialJoystickEvent const &b)
{
	SerialJoystickEvent res(a);
	res -= b;
	return res;
}
...
#endif	// HYDRA_INPUT_SERIAL_JOYSTICK_EVENT_HPP
