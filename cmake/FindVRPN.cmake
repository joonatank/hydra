...
elseif( VRPN_LIBRARY_DEBUG )
	set( VRPN_LIBRARY ${VRPN_LIBRARY_DEBUG} CACHE FILEPATH "VRPN Client library" FORCE)
elseif( VRPN_LIBRARY_RELEASE )
	set( VRPN_LIBRARY ${VRPN_LIBRARY_RELEASE} CACHE FILEPATH "VRPN Client library" FORCE)
else()
